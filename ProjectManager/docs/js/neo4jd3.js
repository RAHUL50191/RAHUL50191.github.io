          ...
          function Neo4jD3(_selector, _options) {
            ...
            function initSimulation() {
              var simulation = d3
                ...
                .force(
                  "center",
                  d3.forceCenter(svg.node().parentElement.parentElement.clientWidth / 2, svg.node().parentElement.parentElement.clientHeight / 2)
                )
                .on("tick", function () {
                  tick();
                })
                ...
                outline.attr("d", function (d) {
                  var center = { x: 0, y: 0 },
                    ...
                    rotatedPointD2 = rotatePoint(
                      center,
                      { x: d.target.x - d.source.x - (options.nodeRadius + 1) * u.x, y: d.target.y - d.source.y - (options.nodeRadius + 1) * u.y },
                      angle
                    ),
